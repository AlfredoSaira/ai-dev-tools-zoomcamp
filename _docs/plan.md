...
**Alternative considered**: Anonymous to teammates but visible to facilitators. Weakens psychological safety.  
...
**Alternatives considered**:  
- Live totals: engaging, but encourages people to follow existing votes.  
...
**Why**: Enough to make outcomes accountable without turning the MVP into a project-management platform.  

**Alternatives considered**: Priorities, subtasks, dependencies, reminders, recurring tasks. Deferred for later integrations.  

### One retrospective belongs to one project
**Decision**: Feedback cycles and retrospectives are organized within projects.  
**Why**: Provides enough structure for recurring teams while keeping permissions and history understandable.  

**Alternative considered**: Organization-wide retrospectives without projects. Simpler initially, but confusing once users join multiple teams.  
...
- % of invited members who submit feedback  
- % of retrospectives completed  
- Number of confirmed actions per retrospective  
- % of actions completed before the next retrospective  
...
- Create a project and weekly feedback cycle  
- Collect private Start, Stop, and Continue cards  
- Reveal and collaboratively cluster the cards  
- Vote with three stackable votes per person  
- Discuss topics in priority order  
- Upload a meeting recording or transcript  
- Review extracted actions and decisions  
- Publish a retrospective summary  
